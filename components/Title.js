...
const Title = ({ title, subtitle, textColor = 'text-primary-950', borderColor = 'border-black' }) => {
  ...
  return (
    ...
    >
      <p
        className={`text-center text-3xl md:text-5xl font-khorla pb-4 md:pb-0 font-bold tracking-wider opacity-80 leading-tight md:leading-none uppercase ${textColor} ${borderColor} border-opacity-20 px-4 underline underline-offset-[18px] decoration-accent-600 mb-5`}
      >
        {title}
      </p>
