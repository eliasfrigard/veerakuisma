  ...
  return (
    <>
      ...
      <div
        ...
        className="z-50 h-12 aspect-square rounded-full bg-primary-950 bg-opacity-60 backdrop-blur fixed bottom-3 md:bottom-6 right-3 md:right-6 shadow-xl flex justify-center items-center hover:bg-accent-500 cursor-pointer duration-150 hover:scale-105"
      >
